...
public class NewEmptyJUnitTest {
    ...
    @Test
    public void isPrime(){
        int[] primesToBe = new int[]{1, 2, 3, 5, 17, 23, 101, 7907, 18232943, 2147483629};
    ...
    public void nextPrime(){
        Assert.assertEquals(1, Primes.nextPrime(0));
    ...
    @Test
    public void previousPrimeTest(){
        Assert.assertEquals(5, Primes.previousPrime(7));
        Assert.assertEquals(11, Primes.previousPrime(12));
        Assert.assertEquals(7, Primes.previousPrime(11));
    }
